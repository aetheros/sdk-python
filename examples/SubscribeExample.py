...
def main():
    try:
        ...
        handlerFactory = AsyncResponseListenerFactory() # default is localhost on post 8080
        handler = handlerFactory.get_instance()
        handler.set_rqi_cb(request_id, request_handler) # Map request id to corresponding handler function.
        handler.start()
